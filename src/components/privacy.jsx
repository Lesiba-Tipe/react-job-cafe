...
const Privacy = () => {
  return (
    <section className="frame-privacy">
        <h1>Our Privacy Policy</h1>
          <p className='updated-date'>Last updated: January 24, 2024</p>
      <div className="disclaimer">
        ...
        <p>
          ...
          Visitors are advised to use the information at their own descretion.
        </p>  
      </div>
      ...
      <div className="privacy-policy text-left">
          ...
          <ul>
            <li>By email: wearejobcafe@gmail.com</li>
          </ul>
        </div>
